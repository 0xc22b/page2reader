...
#
sys.path.insert(0,
                os.path.dirname(os.path.abspath(__file__)) + '/closure-library/closure/bin/build')
#
# End of insert #
#
...
# Begin of insert #
#
  parser.add_option('--cssrenamingmap',
                    dest='cssrenamingmap',
                    action='store',
                    help='The location of the css renaming map file.')
#
# End of insert #
#
...
# Begin of insert #
#
  if options.cssrenamingmap:
    # The cssRenamingMap goes second.
    cssRenamingMap = _PathSource(options.cssrenamingmap)
    deps = [base] + [cssRenamingMap] + tree.GetDependencies(input_namespaces)
  else:
#
# End of insert #
#
